...
class AssetManager:
    ...
    def _load_images(self):
        ...
        image_assets = {
            ...
            'staff': {'color': Colors.NEON_PURPLE, 'emoji': '🪄', 'text': "杖", 'size': int(TILE_SIZE * 0.8), 'rarity': 'uncommon'},
            'crossbow': {'color': Colors.NEON_YELLOW, 'emoji': '🏹', 'text': "弩", 'size': int(TILE_SIZE * 0.8), 'rarity': 'rare'},
            ...
            'magic_robe': {'color': Colors.NEON_PURPLE, 'emoji': '🎽', 'text': "袍", 'size': int(TILE_SIZE * 0.8), 'rarity': 'uncommon'},
            'spiked_armor': {'color': Colors.NEON_ORANGE, 'emoji': '🥋', 'text': "刺", 'size': int(TILE_SIZE * 0.8), 'rarity': 'rare'},
            ...
            'light_boots': {'color': Colors.NEON_GREEN, 'emoji': '👞', 'text': "輕", 'size': int(TILE_SIZE * 0.8), 'rarity': 'common'},
            'iron_boots': {'color': Colors.NEON_CYAN, 'emoji': '🥾', 'text': "鐵", 'size': int(TILE_SIZE * 0.8), 'rarity': 'uncommon'},
            ...
            'ring_defense': {'color': Colors.NEON_CYAN, 'emoji': '💍', 'text': "盾", 'size': int(TILE_SIZE * 0.8), 'ring': True},
            'ring_swift': {'color': Colors.NEON_ORANGE, 'emoji': '💍', 'text': "速", 'size': int(TILE_SIZE * 0.8), 'ring': True},
            'ring_fortune': {'color': Colors.NEON_YELLOW, 'emoji': '💍', 'text': "福", 'size': int(TILE_SIZE * 0.8), 'ring': True},
            'amulet_protection': {'color': Colors.NEON_CYAN, 'emoji': '🏅', 'text': "護", 'size': int(TILE_SIZE * 0.8), 'amulet': True},
            'amulet_life': {'color': Colors.NEON_RED, 'emoji': '🏅', 'text': "命", 'size': int(TILE_SIZE * 0.8), 'amulet': True},
            'amulet_might': {'color': Colors.NEON_ORANGE, 'emoji': '🏅', 'text': "力", 'size': int(TILE_SIZE * 0.8), 'amulet': True},
            'amulet_magic': {'color': Colors.NEON_PURPLE, 'emoji': '🏅', 'text': "魔", 'size': int(TILE_SIZE * 0.8), 'amulet': True},
            'amulet_fortune': {'color': Colors.NEON_YELLOW, 'emoji': '🏅', 'text': "運", 'size': int(TILE_SIZE * 0.8), 'amulet': True},
