...
class ItemDatabase:
    ...
    def __init__(self):
        self.weapon_data = {
            ...
            'staff': {'name': GameTexts.WEAPON_STAFF, 'attack': 4, 'value': 140, 'rarity': 'uncommon'},
            'crossbow': {'name': GameTexts.WEAPON_CROSSBOW, 'attack': 7, 'value': 200, 'rarity': 'rare'},
        ...
        self.armor_data = {
            ...
            'magic_robe': {'name': GameTexts.ARMOR_ROBE, 'defense': 3, 'value': 180, 'rarity': 'uncommon'},
            'spiked_armor': {'name': GameTexts.ARMOR_SPIKED, 'defense': 5, 'value': 350, 'rarity': 'rare'},
        ...
        self.boots_data = {
            ...
            'light_boots': {'name': '輕便長靴', 'defense': 1, 'move_speed': 80, 'value': 120, 'rarity': 'common'},
            'iron_boots': {'name': '鐵靴', 'defense': 3, 'move_speed': -30, 'value': 140, 'rarity': 'uncommon'},
        ...
        self.ring_data = {
            ...
            'ring_defense': {'name': GameTexts.RING_DEFENSE, 'defense': 2, 'value': 160, 'rarity': 'uncommon'},
            'ring_swift': {'name': GameTexts.RING_SWIFT, 'move_speed': 150, 'value': 180, 'rarity': 'rare'},
        ...
        self.amulet_data = {
            ...
            'amulet_magic': {'name': GameTexts.AMULET_MAGIC, 'mp': 20, 'value': 220, 'rarity': 'rare'},
            'amulet_fortune': {'name': GameTexts.AMULET_FORTUNE, 'value': 350, 'rarity': 'epic'}
        }
